...
def realiser_xgb(patient):
    ...
    probabilities = xgb_model.predict_proba(patient_scaled)[0]
    ...
    print(f"XGB | Patient : {prob_malade:.2f}% malade - {prob_non_malade:.2f}% non-malade")
