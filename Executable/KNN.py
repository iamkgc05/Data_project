...
def realiser_knn(patient):
    ...
    probabilities = knn.predict_proba(patient_scaled)[0]
    
    # Calculer les pourcentages
    prob_non_malade = probabilities[0] * 100
    prob_malade = probabilities[1] * 100
    
    # Afficher les pourcentages (peut être supprimé si non souhaité)
    print(f"KNN | Patient : {prob_malade:.2f}% malade - {prob_non_malade:.2f}% non-malade")
