...
def realiser_lg(patient):
    ...
    lg = LogisticRegression(C=10, solver='liblinear', penalty='l2', random_state=random_state)
    lg.fit(x_train, y_train)

    # Obtenir les probabilités de prédiction
    probabilities = lg.predict_proba(patient_scaled)[0]
    ...
    print(f"LG | Patient : {prob_malade:.2f}% malade - {prob_non_malade:.2f}% non-malade")
