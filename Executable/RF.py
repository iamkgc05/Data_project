...
def realiser_rf(patient):
    ...
    rf = RandomForestClassifier(n_estimators=138, max_depth=18, random_state=random_state)
    rf.fit(x_train, y_train)

    # Obtenir les probabilités de prédiction
    probabilities = rf.predict_proba(patient_scaled)[0]
    ...
    print(f"RF | Patient : {prob_malade:.2f}% malade - {prob_non_malade:.2f}% non-malade")
